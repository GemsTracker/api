CREATE TABLE gems__prediction_model_mapping (
  gpmm_id bigint unsigned not null auto_increment,
  gpmm_track_id bigint unsigned not null,
  gpmm_prediction_model_id bigint unsigned not null,

  gpmm_required tinyint(1) unsigned not null DEFAULT '0',
  gpmm_variable_name varchar(100) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' not null,
  gpmm_variable_type varchar(100) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' not null,
