...
class TreatmentModel extends \Gems_Model_JoinModel
{
    ...
    public function __construct()
    {
        ...
        $this->addLeftTable(['treatmentDateField' => 'gems__track_fields'], ['gr2t_id_track' => 'treatmentDateField.gtf_id_track', 'treatmentDateField.gtf_field_code' => new \Zend_Db_Expr('\'treatmentDate\'')], 'gtf', false);
