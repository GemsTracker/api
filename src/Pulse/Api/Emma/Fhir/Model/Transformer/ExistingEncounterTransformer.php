...
/**
 * Match existing appointment to the source ID
 */
class ExistingEncounterTransformer extends \MUtil_Model_ModelTransformerAbstract
{
    /**
    ...
    public function transformRowBeforeSave(\MUtil_Model_ModelAbstract $model, array $row)
    {
        ...
        if ($appointment) {
            ...
            $row['existingOrganizationId'] = $appointment['gap_id_organization'];
        }
