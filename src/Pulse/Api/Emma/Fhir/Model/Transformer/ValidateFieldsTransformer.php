...
use Depar\Cli\Model\ModelValidationException;
...
class ValidateFieldsTransformer extends \MUtil_Model_ModelTransformerAbstract
{
    ...
    /**
     * @var \MUtil_Model_ModelAbstract|null
     */
    protected $model;
     ...
     */
    public function getValidator($validator, array $options=null)
    {
        if ($validator instanceof \Zend_Validate_Interface) {
            ...
            if ($options !== null) {
                $validator = $this->overLoader->create('Validate_' . $validator, $options);
            } else {
                $validator = $this->overLoader->create('Validate_'.$validator);
            }
    ...
    public function transformRowBeforeSave(\MUtil_Model_ModelAbstract $model, array $row)
    {
        ...
        if (count($errors)) {
            ...
            throw new \Gems\Rest\Model\ModelValidationException(sprintf('Errors were found when validating %s', $modelName), $errors);
        }
